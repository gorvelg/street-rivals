...
/*
 * Ligne narrative générée côté backend
 * et conservée dans le replay.
 */
export type NarrativeLineType =
    | 'card_activation'
    | 'card_effect'
    | 'card_reaction'
...
export interface TriggeredCard {
     ...
     * avec les anciens replays moteur 1.1.0.
     */
